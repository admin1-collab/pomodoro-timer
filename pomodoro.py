...
MODES = {
    ...
    "short_break": {"label": "短休息", "minutes": 5,  "color": "#2ECC71", "accent": "#27AE60"},
    "long_break":  {"label": "长休息", "minutes": 15, "color": "#3498DB", "accent": "#2980B9"},
}
...
class PomodoroApp:
    ...
    def build_ui(self):
        ...
        # -- bottom hint --
        hint = tk.Label(self.root, text="右键菜单 | 拖动窗口", bg=BG, fg="#3A3A3A",
                        font=("Segoe UI", 8))
